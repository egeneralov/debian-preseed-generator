...
rm -f debian-9.8.0-amd64-netinst.iso initrd.gz preseed-debian-9.8.0-amd64-netinst.iso vmlinuz  debian-9.8.0-amd64-netinst.iso.torrent test.img
...
-cdrom preseed-debian-9.8.0-amd64-netinst.iso \
-hda test.img \
